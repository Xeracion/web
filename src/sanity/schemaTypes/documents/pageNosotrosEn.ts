...
export const pageNosotrosEn = defineType({
  name: 'pageNosotrosEn',
  title: 'Página About (English)',
  type: 'document',
  groups: [
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Partners',
      description:
        'Cada partner puede llevar su logo. Mientras no se suba, se muestra el nombre como texto.',
      type: 'array',
      of: [{ type: 'partner' }],
      group: 'partners',
    }),
    ...
    defineField({
      ...
      description:
        'A dónde lleva el botón. Puede ser una ruta interna (ej. "/volunteering/") o una URL completa. Si lo dejas vacío, lleva a "/volunteering/".',
      type: 'string',
      group: 'cierre',
    }),
  ],
  preview: {
    ...
    prepare({ title }) {
      return { title: title || 'Página About (English)' }
    },
  },
})
