...
- Sticky, fondo translúcido: `background: rgba(250,250,247,0.92)` + `backdrop-filter: blur(12px)`.
- Izquierda: logo texto "Xeración", Fraunces 22px, weight 500, letter-spacing -0.02em.
- Derecha desktop: `Ferrol · Irse · English · [separador] · Sobre nós` — los tres primeros con color de acento sutil al hover; el cuarto en gris suave.
- Derecha móvil (< 768px): hamburguesa → overlay a pantalla completa desde la derecha, slide-in 300ms.
- Padding vertical: 18px desktop / 14px móvil.
- Borde inferior: 0.5px `#D3D1C7`.
